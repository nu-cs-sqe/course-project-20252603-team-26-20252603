...
1. [done] Alivia, Ben, Sidney, Sophie: Design documentation done on meeting (https://github.com/nu-cs-sqe/course-project-20252603-team-26-20252603/pull/6)
2. [done] Ben: Model layer part A1 - Game, Player, Deck, DiscardPile do BVA, unit test, basic code (https://github.com/nu-cs-sqe/course-project-20252603-team-26-20252603/pull/15)\
