...
- **TC1: chooseCard_FirstIndex_ReturnsExplanation** (:x: or :white_check_mark:)
...
- **TC2: chooseCard_LastIndex_ReturnsExplanation** (:x: or :white_check_mark:)
...
- **TC3: chooseCard_MiddleIndex_ReturnsExplanation** (:x: or :white_check_mark:)
