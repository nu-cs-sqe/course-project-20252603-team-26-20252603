...
| `DECK-BURY-3` | Move the top card of a multi-card deck to the bottom. | The former top card becomes the bottom card and all other cards retain their relative order. | :white_check_mark: |
